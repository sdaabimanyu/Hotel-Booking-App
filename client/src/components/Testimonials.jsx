...
export default function Testimonials() {
  return (
    <div className="flex flex-col items-center py-15 bg-slate-50">
      <h1 className="text-[40px] font-playfair">What Our Guests Say</h1>
      <p className="text-center text-gray-500/90 max-w-3xl">
